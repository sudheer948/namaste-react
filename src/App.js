  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img className="logo" src="https://tinyurl.com/ezu448c3" />
      </div>
...
const resList = [
  {
    ...
    analytics: {
      context: "seo-data-c4c50b03-30ee-4b0c-8109-1cf1840007b9",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2026-03-09 22:30:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2026-03-09 22:45:00",
        opened: true,
      },
      badges: {
        imageBadges: [
